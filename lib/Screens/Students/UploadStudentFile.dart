...
class Uploadstudentfile extends StatefulWidget {
  final String SID;
  const Uploadstudentfile({super.key, required this.SID});

  @override
  State<Uploadstudentfile> createState() => _UploadstudentfileState();
}

class _UploadstudentfileState extends State<Uploadstudentfile> {
  bool loading = false;
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () async {
                  ...
                  upadteImageURl(String StudentImageUrl, String FileName) {
                    final docUser = FirebaseFirestore.instance
                        .collection("StudentFileInfo")
                        .doc(code.toString());
                    final updateImage = {
                      "FileID": code.toString(),
                      "FileUrl": StudentImageUrl,
                      "SIDNo": widget.SID,
                      "FileName": FileName,
                    };
                  ...
                  upadteImageURl(
                      UploadImageURl, FileNameController.text.trim());
                },
                child: Text("Save"))
          ],
        ),
